...
#ifndef VERILATED_VPVUTOP_COMPRESSOR4TO2_18_H_
#define VERILATED_VPVUTOP_COMPRESSOR4TO2_18_H_  // guard

#include "verilated.h"

class VPvuTop__Syms;

class VPvuTop_Compressor4to2_18 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VPvuTop_Compressor4to2_18(VPvuTop__Syms* symsp, const char* v__name);
    ~VPvuTop_Compressor4to2_18();
    VL_UNCOPYABLE(VPvuTop_Compressor4to2_18);

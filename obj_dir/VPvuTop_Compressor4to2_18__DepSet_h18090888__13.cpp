...
VL_INLINE_OPT void VPvuTop_Compressor4to2_18___ico_comb__TOP__PvuTop__DOT__div__DOT__intdivider_2__boothMult__DOT__csaTree__DOT__csa_tree_A__DOT__csa_tree_A__csa_tree_B__DOT__compressor__0(VPvuTop_Compressor4to2_18* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VPvuTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                      VPvuTop_Compressor4to2_18___ico_comb__TOP__PvuTop__DOT__div__DOT__intdivider_2__boothMult__DOT__csaTree__DOT__csa_tree_A__DOT__csa_tree_A__csa_tree_B__DOT__compressor__0\n"); );
    // Init
...
VL_INLINE_OPT void VPvuTop_Compressor4to2_18___ico_comb__TOP__PvuTop__DOT__div__DOT__intdivider_2__boothMult__DOT__csaTree__DOT__csa_tree_A__DOT__csa_tree_B__compressor__0(VPvuTop_Compressor4to2_18* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VPvuTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                      VPvuTop_Compressor4to2_18___ico_comb__TOP__PvuTop__DOT__div__DOT__intdivider_2__boothMult__DOT__csaTree__DOT__csa_tree_A__DOT__csa_tree_B__compressor__0\n"); );
    // Init
    CData/*0:0*/ __PVT__counter__DOT___carryWire_T_4;
    __PVT__counter__DOT___carryWire_T_4 = 0;
    CData/*0:0*/ __PVT__counter_1__DOT___carryWire_T_4;

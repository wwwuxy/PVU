...
VL_ATTR_COLD void VPvuTop_IntDivider___ctor_var_reset(VPvuTop_IntDivider* vlSelf) {
    ...
    vlSelf->__PVT__boothMult__DOT__genProds__DOT___genProd_10_io_partial_prod = VL_RAND_RESET_I(25);
    vlSelf->__PVT__boothMult__DOT__genProds__DOT___genProd_9_io_partial_prod = VL_RAND_RESET_I(25);
    vlSelf->__PVT__boothMult__DOT__genProds__DOT___genProd_8_io_partial_prod = VL_RAND_RESET_I(25);
    vlSelf->__PVT__boothMult__DOT__genProds__DOT___genProd_7_io_partial_prod = VL_RAND_RESET_I(25);
    vlSelf->__PVT__boothMult__DOT__genProds__DOT___genProd_6_io_partial_prod = VL_RAND_RESET_I(25);
    vlSelf->__PVT__boothMult__DOT__genProds__DOT___genProd_4_io_partial_prod = VL_RAND_RESET_I(25);
    vlSelf->__PVT__boothMult__DOT__genProds__DOT___genProd_3_io_partial_prod = VL_RAND_RESET_I(25);
    vlSelf->__PVT__boothMult__DOT__genProds__DOT___genProd_2_io_partial_prod = VL_RAND_RESET_I(25);
    vlSelf->__PVT__boothMult__DOT__genProds__DOT___genProd_1_io_partial_prod = VL_RAND_RESET_I(25);
    vlSelf->__PVT__boothMult__DOT__genProds__DOT___genProd_io_partial_prod = VL_RAND_RESET_I(25);
    ...
    vlSelf->__VdfgTmp_hf986c990__0 = 0;
    ...
    vlSelf->__VdfgTmp_h18d87cd9__0 = 0;
    vlSelf->__VdfgTmp_hafe47ac3__0 = 0;
}

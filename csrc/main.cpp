...
void check_outputs(VPvuTop* dut,
                   const uint16_t expected_o[4],
                   uint16_t expected_dot_o)
{
    bool pass = true;

    uint16_t actual_o[4] = {
        static_cast<uint16_t>(dut->io_posit_o_0),
        static_cast<uint16_t>(dut->io_posit_o_1),
        static_cast<uint16_t>(dut->io_posit_o_2),
        static_cast<uint16_t>(dut->io_posit_o_3)
    };
    uint16_t actual_dot_o = static_cast<uint16_t>(dut->io_posit_dot_o);
...
int main(int argc, char** argv) {
    ...
    //--------------------------------------------------
    {
        ...
        uint16_t test_i1[4] = {0x4000, 0x4000, 0x4000, 0x4000}; // 1.0?
        uint16_t test_i2[4] = {0x4000, 0x4000, 0x4000, 0x4000}; // 1.0?
        uint8_t  test_op    = 1; // 加法

        // 2.0 => 0x6000? (示例)
        // 8.0 => 0x7C00? (示例)
        uint16_t expected_o[4]  = {0x6000, 0x6000, 0x6000, 0x6000}; 
        uint16_t expected_dot_o = 0x7C00; // 8.0 ?
    ...
    //     uint16_t test_i1[4] = {0x6000, 0x6000, 0x6C00, 0x6C00}; // 2.0, 2.0, 3.0, 3.0
    //     uint16_t test_i2[4] = {0x6C00, 0x6C00, 0x6000, 0x6000}; // 3.0, 3.0, 2.0, 2.0
    //     uint8_t  test_op    = 1; // 加法

    //     uint16_t expected_o[4]  = {0x7400, 0x7400, 0x7400, 0x7400}; // 5.0 ?
    //     uint16_t expected_dot_o = 0x7A00; // 20 ?
    ...
    //     uint16_t test_i1[4] = {0x6000, 0x6C00, 0x6000, 0x6C00};
    //     uint16_t test_i2[4] = {0x6C00, 0x6000, 0x6C00, 0x6000};
    //     uint8_t  test_op    = 3; // 乘法

    //     uint16_t expected_o[4]  = {0x7A00, 0x7A00, 0x7A00, 0x7A00}; // 6.0 ?
    //     uint16_t expected_dot_o = 0x7E00; // 24 ?
    ...
    //     uint16_t test_i1[4] = {0xC000, 0xC000, 0xC000, 0xC000}; // -1.0?
    //     uint16_t test_i2[4] = {0x6000, 0x6000, 0x6000, 0x6000}; // 2.0?
    //     uint8_t  test_op    = 1; // 加法

    //     uint16_t expected_o[4]  = {0x4000, 0x4000, 0x4000, 0x4000}; // 1.0?
    //     uint16_t expected_dot_o = 0x7000; // 4.0 ?
...
//----------------------------------------------------------------------
void check_outputs(VPvuTop* dut, uint16_t expected_o, uint16_t expected_dot_o)
{
    bool pass = true;

    // 读取实际输出
    uint16_t actual_o     = static_cast<uint16_t>(dut->io_posit_o_0);
    uint16_t actual_dot_o = static_cast<uint16_t>(dut->io_posit_dot_o);
...
//----------------------------------------------------------------------
void set_inputs(VPvuTop* dut, uint16_t i1, uint16_t i2, uint8_t op)
{
...
int main(int argc, char** argv) {
    ...
    //===============================================================
    {
        ...
        uint16_t expected_o     = 0x4800; 
        uint16_t expected_dot_o = 0; 
    ...
    //     uint16_t expected_o     = 0x7A00; 
    //     uint16_t expected_dot_o = 0x7A00; 

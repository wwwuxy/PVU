...
int main(int argc, char** argv) {
    ...
    {
        printf("Test Mul\n");
        uint32_t test_i1[4] = {0x00000000, 0x4c000000, 0x4c000000, 0x4c000000};
        uint32_t test_i2[4] = {0x00000000, 0x58000000, 0x60000000, 0x61000000};
        uint8_t  test_op    = 3; // 乘法

        uint32_t expected_o[4]  = {0x00000000, 0x62000000, 0x66000000, 0x67800000}; 
    ...
    //--------------------------------------------------
    {
        ...
        uint32_t expected_o  = 0x00000000; 

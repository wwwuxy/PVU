#include"../config.h"
#ifdef CONFIG_SHUFFLENETV2_DOT_P32 
...
const char* GOLDEN_FILE = "./test_src/ShuffleNetv2/dot_product_results.bin";
...
int main(int argc, char** argv) {
    ...
    std::cout << "开始Shufflenetv2点积性能测试，样本数: " << test_samples << std::endl;

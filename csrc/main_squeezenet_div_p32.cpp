#include"../config.h"
#ifdef CONFIG_SQUEEZENET_DIV_P32
...
//---------------- 配置参数 -------------------
#define OP   4
const char* ACT_FILE    = "./test_src/SqueezeNet/posit_activations.bin";
const char* WEIGHT_FILE = "./test_src/SqueezeNet/posit_weights.bin";
const char* GOLDEN_FILE = "./test_src/SqueezeNet/div_results.bin";

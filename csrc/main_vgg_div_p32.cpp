...
//---------------- 配置参数 -------------------
#define OP   4
const char* ACT_FILE    = "./test_src/VGG/posit_activations.bin";
const char* WEIGHT_FILE = "./test_src/VGG/posit_weights.bin";
const char* GOLDEN_FILE = "./test_src/VGG/div_results.bin";

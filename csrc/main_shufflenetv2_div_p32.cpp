#include"../config.h"
#ifdef CONFIG_SHUFFLENETV2_DIV_P32
...
//---------------- 配置参数 -------------------
#define OP   4
const char* ACT_FILE    = "./test_src/ShuffleNetv2/posit_activations.bin";
const char* WEIGHT_FILE = "./test_src/ShuffleNetv2/posit_weights.bin";
const char* GOLDEN_FILE = "./test_src/ShuffleNetv2/div_results.bin";
...
// io_op: 操作类型 [2:0] - 4表示除法
// 
// 输出接口:
// io_posit_o_0~3: posit格式输出 [31:0]
// io_posit_dot_o: posit点积结果 [31:0]
//--------------------------------------------
